...
namespace kombinatorika9
{
    /*
     * Pronađite broj koji se sastoji od 9 znamenki u kojem se svaka 
     * znamenka od 1 do 9 pojavljuje samo jednom. Ovaj broj također 
     * mora zadovoljiti ove zahtjeve djeljivosti:
     *      Broj bi trebao biti djeljiv sa 9.
     *      Ako se ukloni krajnja desna znamenka, preostali broj bi 
     *      trebao biti djeljiv s 8.
     *      Ako se ukloni krajnja desna znamenka novog broja, 
     *      preostali broj treba biti djeljiv sa 7.
     *      I tako dalje, sve dok ne bude samo jedna znamenka 
     *      (koja će nužno biti djeljiva s 1).
     *      
